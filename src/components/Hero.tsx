        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-lg">
              ...
              Co-Founder & CTO at Vionex Digital Solutions and Technical Lead at Retailo, leveraging AI, ML, and computer vision to build scalable,
              business-aligned solutions across Egypt, Africa, and the Middle East.
              With a B.Sc. in Computer Science & AI and ongoing M.Sc. in Data Science, I also contribute to AI education as an Instructor at NTI.
              Passionate about solving real-world challenges through NLP, computer vision, and large language models.
            </p>
